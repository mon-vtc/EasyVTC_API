...
export const sendNotificationSchema = z.object({
  ...
  type:    z.enum([
    ...
    'new_message', 'new_reservation_admin', 'new_document_admin',
    ...
    'trip_started', 'driver_reminder_24h', 'driver_reminder_2h', 'driver_reminder_30min',
    'weekly_digest_admin', 'marketing', 'support_reply',
  ]),
