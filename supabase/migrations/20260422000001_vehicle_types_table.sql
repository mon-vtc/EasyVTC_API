...
-- 3. Migration des colonnes vehicles.type, drivers.vehicle_type,
--    reservations.vehicle_type : enum → TEXT
...
-- ── 3. Migration enum → TEXT ──────────────────────────────────────────────────
-- PostgreSQL permet de caster directement une valeur enum en TEXT.

ALTER TABLE public.vehicles
  ALTER COLUMN type TYPE TEXT;

ALTER TABLE public.drivers
  ALTER COLUMN vehicle_type TYPE TEXT;
